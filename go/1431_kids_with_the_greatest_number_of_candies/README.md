...
#### Solution 1: 
This took me longer than I thought as my test cases failed.  I didn't clarify and 
thought we added candies to all of them and then tested.

I also had an error where i made `candiesPlus := candies` and they pointed to the same
memory location and I had to look up the slice copy.
